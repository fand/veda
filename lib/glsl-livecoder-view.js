...
export default class GlslLivecoderView {
  constructor() {
    ...
    this.style.innerHTML = `
      body, atom-workspace, .header *, .footer *, atom-workspace-axis :not(.cursor):not(autocomplete-suggestion-list):not(atom-overlay):not(span):not(.region), atom-workspace *:before {
