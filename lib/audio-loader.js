...
export default class AudioLoader {
    ...
    _spectrum: THREE.DataTexture;
    _samples: THREE.DataTexture;
    ...
    constructor() {
      ...
      this._spectrum = new THREE.DataTexture(
        this._spectrumArray,
      ...
      this._samples = new THREE.DataTexture(
        this._samplesArray,
        this._analyser.frequencyBinCount,
        1,
        THREE.LuminanceFormat,
    ...
    update(): void {
      ...
      this._samples.needsUpdate = true;
    }
