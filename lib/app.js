...
class App {
    ...
    startCapturing() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.capturingFrames = 0;
            this.capturedFrames = 0;
            this.captureDir = path.resolve(os.tmpdir(), 'veda-capture-' + Date.now().toString());
            yield p(fs.mkdir)(this.captureDir);
            ...
            const capture = () => __awaiter(this, void 0, void 0, function* () {
                ...
                const filename = this.capturingFrames.toString().padStart(10, '0') + '.png';
    ...
    stopCapturing() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const timer = setInterval(() => {
                ...
                clearTimeout(timer);
                atom.notifications.addSuccess(`[VEDA] Captured to ${this.captureDir}`);
            }, 300);
        });
    }
}
