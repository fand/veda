...
class App {
    ...
    createPasses(rcPasses, shader, postfix, dirname, useGlslify, isGLSL3) {
        ...
        return Promise.all(rcPasses.map((rcPass, i) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!rcPass.fs && !rcPass.vs) {
                ...
                if (rcPass.vs) {
                    pass.vs = yield (0, validator_1.loadFile)(this.glslangValidatorPath, path.resolve(dirname, rcPass.vs), useGlslify);
                    if (i === lastPass &&
                ...
                if (rcPass.fs) {
                    pass.fs = yield (0, validator_1.loadFile)(this.glslangValidatorPath, path.resolve(dirname, rcPass.fs), useGlslify);
                    if (i === lastPass &&
    ...
    loadShaderOfEditor(editor, isSound) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!isSound) {
                    yield (0, validator_1.validator)(this.glslangValidatorPath, shader, postfix);
                }
                const matcharray = (shader.split('\n')[0].match(/(#version 300 es)/) || []);
                const isGLSL3 = !!matcharray[0];
                const passes = yield this.createPasses(rc.PASSES, shader, postfix, dirname, rc.glslify, isGLSL3);
                if (isSound) {
