...
export default {
  ...
  _activate(state) {
    ...
    this.app.setVertexCount(atom.config.get('glsl-livecoder.vertexCount'));
    this.app.setVertexMode(atom.config.get('glsl-livecoder.vertexMode'));
    ...
    atom.config.observe('glsl-livecoder.vertexCount', x => {
      this.app.setVertexCount(x);
      this.app.loadLastShader();
    });
    atom.config.observe('glsl-livecoder.vertexMode', x => {
      this.app.setVertexMode(x);
      this.app.loadLastShader();
    });
