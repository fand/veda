...
class Config extends events_1.EventEmitter {
    constructor(projectPath, rc) {
        ...
        this._fileRc = {};
        this._soundRc = {};
        this._lastImportedHash = {};
        this._isWatching = false;
        this._readConfigFile = (filename) => {
    ...
    createRc() {
        const IMPORTED = Object.assign({}, this._projectRc.IMPORTED, this._fileRc.IMPORTED);
        return Object.assign({}, DEFAULT_RC, this._globalRc, this._projectRc, this._fileRc, { IMPORTED });
    }
    createSoundRc() {
        const IMPORTED = Object.assign({}, this._projectRc.IMPORTED, this._soundRc.IMPORTED);
        return Object.assign({}, DEFAULT_RC, this._globalRc, this._projectRc, this._soundRc, { IMPORTED });
    }
    setGlobalSettings(rc) {
        this._globalRc = Object.assign({}, this._globalRc, rc);
        this.onChange();
    }
    ...
    _parseComment(filepath, comment) {
        let rc = {};
        try {
